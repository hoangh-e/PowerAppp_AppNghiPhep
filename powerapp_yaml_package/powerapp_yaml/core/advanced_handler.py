...
class AdvancedYAMLHandler:
    ...
    def load_from_string(self, yaml_string: str) -> 'AdvancedYAMLHandler':
    ...
    def create_sample_button_component(self) -> 'AdvancedYAMLHandler':
    ...
    def create_from_template(self, template_name: str = "basic_button") -> 'AdvancedYAMLHandler':
...
"""
    ...
    def __str__(self) -> str:
        ...
        if self.data and self.data.component_definitions:
            ...
            return f"AdvancedYAMLHandler - Components: {total} (Dataclass-based)"
        return "AdvancedYAMLHandler - Empty"
...
def test_final_yaml_handler():
    ...
    print("🧪 Testing AdvancedYAMLHandler (Dataclass-based)...")
    
    # Test 1: Tạo sample component
    print("\n1. Tạo sample component với dataclasses:")
    handler = AdvancedYAMLHandler().create_sample_button_component()
    print(handler)
    ...
    for template_name in ["basic_button", "input_field", "card_layout"]:
        ...
        template_handler = AdvancedYAMLHandler().create_from_template(template_name)
    ...
    try:
        original_handler = AdvancedYAMLHandler().load_from_file("src/Components/ButtonComponent.yaml")
